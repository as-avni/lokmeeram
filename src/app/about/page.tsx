    ...
    return (
        <section id="about" className="w-full py-12 px-4 items-center gap-4 bg-[url('/images/about-team/about-us-bg.png')] bg-cover h-auto md:h-[600]">
            ...
            <div className="flex flex-col md:flex-row border-spacing-2">
                <div className="flex-1 w-full md:w-1/2 md:mx-10 md:my-4 my-4 md:mb-4 border border-gray-500 shadow-slate-600 shadow-2xl rounded-xl bg-yellow-100 h-[80%] overflow-hidden relative group">
                    ...
                    <div className="hidden group-hover:block mx-5 p-4">
                        ...
                        <button 
                            ...
                            className="mt-4 mb-3 md:mb-4 md:py-4 text-black font-bold text-lg/[30px] bg-yellow-200 rounded-3xl md:p-0 p-2 md:w-1/6">
                            और पढ़ें
                        </button>
                    </div>
                        ...
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                            <div className="bg-yellow-100 w-[95%] h-[95%] md:w-[50%] md:h-[80%] rounded-lg p-5 overflow-y-auto relative">
                                <p className="text-black text-md md:text-xl p-4">
                                    ...
                                    लेकिन यह हम-सभी के लिए बेहद अफसोस जनक है कि इतिहास की लंबी धारा में किन्ही दुर्भाग्यशाली क्षणों में हमारी रामरूपी आध्यात्मिक संपदा हमसे इतनी दूर होती चली गई कि इससे उत्पन्न आर्थिक एवं सामाजिक अवनति का शिकार हुआ।<br/><br/>
