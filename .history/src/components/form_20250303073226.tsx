    ...
    {step === 1 && (
      <form onSubmit={(e) => e.preventDefault()} className="max-w-3xl mx-auto space-y-4 p-6 text-2xl text-black border-orange-200 hover:border-orange-300">
        ...
        <div>
          ...
          <Textarea name="message" value={formData.message} onChange={handleChange} placeholder="अपना संदेश यहाँ लिखें" className="text-black border-orange-200 hover:border-orange-500" />
        </div>
