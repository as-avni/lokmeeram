...
const TOTAL_VIDEOS = 9; // Approximate limit to avoid infinite loops
...
const YouTubeEmbed: React.FC = () => {
  ...
  const loadMoreVideos = () => {
    if (visibleVideos < TOTAL_VIDEOS) {
      setVisibleVideos((prev) => Math.min(prev + 3, TOTAL_VIDEOS));
    }
  };
