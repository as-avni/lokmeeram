...
const YouTubeEmbed: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full">
      <div
        className="elfsight-app-e8c14538-364d-487b-bd5e-669e81a8950a w-full max-w-4xl"
...
//           <div 
//             key={index} 
//             className="relative w-full aspect-w-16 aspect-h-12 cursor-pointer"
//             onClick={() => setSelectedVideo(`https://www.youtube.com/embed?listType=playlist&list=${PLAYLIST_ID}&index=${index + 1}`)}
//           >
//             <iframe
//               className="w-full h-full rounded-lg shadow-lg aspect-w-16 aspect-h-12"
