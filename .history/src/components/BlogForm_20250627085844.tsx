        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full border border-orange-300 px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 placeholder:text-sm text-black"
              required
            />
          </div>
                    <div>
            ...
            <input
              ...
              className="text-black border-orange-300 hover:border-orange-500 w-full border px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 placeholder:text-sm"
            />
          </div>
