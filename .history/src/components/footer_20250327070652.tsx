    ...
    return (
        ...
        <div className="container mx-auto px-4 py-8 mt-8">
            ...
            <div className="py-6 md:py-10 text-left">
                ...
                <li><Link href="/#galleryevents" className="text-base font-semibold hover:text-orange-600 text-black">आयोजन</Link></li>
                <li><Link href="/" className="text-base font-semibold hover:text-orange-600 text-black">फोटो गैलरी</Link></li>
