    ...
    <section className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-4 rounded-lg shadow-2xl">
          <div className="flex items-center gap-2 mb-4 text-2xl font-semibold text-blue-500">
        ...
        <div className="p-4 rounded-lg shadow-lg">
          <div className="flex items-center gap-2 mb-4 text-2xl font-semibold text-pink-500">
        ...
        {/* Twitter (X) Section */}
        <div className="p-4 rounded-lg shadow-lg">
          <div className="flex items-center gap-2 mb-4 text-lg font-semibold "text-black">
