    ...
    return (
        ...
        <div className="container mx-auto px-4 py-8 mt-8">
            ...
            <div className="py-10">
                ...
                <li>
                    <Link href="/events" className=" text-xl font-semibold text-orange-600 hover:text-black">
                    आयोजन
                    </Link>
                </li>
                <li>
                    <Link href="/#gallery" className="text-xl font-semibold text-orange-600 hover:text-black">
                    फोटो गैलरी
                    </Link>
                </li>
                <li>
                    <Link href="/#team" className="text-xl font-semibold text-orange-600 hover:text-black">
                    संस्थापक
                    </Link>
                </li>
                </ul>
            ...
            <div className="py-10">
                <h3 className=" text-2xl font-semibold mb-4 relative inline-block hover:text-orange-600 text-black">
                संपर्क करें
                <span className="absolute bottom-0 left-0 w-1/2 h-0.5 bg-orange-500"></span>
                </h3>
                <div className=" text-xl font-semibold hover:text-orange-600 text-black space-y-2">
                <p>सिविल लाइन</p>
            ...
            <div className="py-10">
                ...
                <Link href="#" className="text-xl font-semibold text-orange-600 :text-black ">
