    ...
    return (
        ...
        <div className="container mx-auto px-4 py-8 mt-8">
            ...
            {/* Contact Section */}
            <div className="py-4">
                <h3 className=" text-2xl font-semibold mb-4 relative inline-block text-xl font-semibold text-orange-600 hover:text-black">
                संपर्क करें
                <span className="absolute bottom-0 left-0 w-1/2 h-0.5 bg-orange-500"></span>
                </h3>
            ...
            <div className="text-xl font-semibold text-orange-600 hover:text-black py-4">
