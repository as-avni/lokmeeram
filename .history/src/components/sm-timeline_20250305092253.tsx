...
export default function SocialMediaTimeline() {
    return (
        <>
            <YouTubeSection />
            {/* <h1 className="text-3xl text-black text-center md:text-5xl font-bold mb-2 md:mb-4">
                <span className="text-orange-600">
                सोशल </span> मीडिया
            </h1>
            <div className="bg-[#fff5ef]  grid grid-cols-1 md:grid-cols-3 justify-between">
                <div>
                ...
                <div>
                    <div className="mx-auto justify-center rounded-lg">
