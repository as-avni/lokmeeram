    ...
    return (
        ...
        <div className="container mx-auto px-4 py-8 mt-8">
            ...
            {/* Quick Links Section */}
            <div className="py-4">
                <h3 className="text-lg font-semibold mb-4 relative inline-block text-orange-700 hover:text-black">
                क्विक लिंक्स
                <span className="absolute bottom-0 left-0 w-1/2 h-0.5 bg-orange-500"></span>
                </h3>
                <ul className="space-y-2">
                <li>
                    <Link href="#" className=" text-xl font-semibold  text-orange-700 hover:text-black">
                    हमारे बारे में
                    </Link>
                </li>
                <li>
