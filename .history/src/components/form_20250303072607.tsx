  ...
  <div className="w-full">
    ...
    {step === 2 && (
      <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-4 p-6 text-2xl text-black">
        ...
        <div>
          <label className="block text-lg font-medium mb-1 text-black">भुगतान स्क्रीनशॉट अपलोड करें</label>
          <Input type="file" accept="image/*" onChange={handleFileChange} className="text-black border-orange-100 hover:border-orange-400" />
