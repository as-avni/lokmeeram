  ...
  <div className="w-full">
    ...
    {step === 1 && (
      <form onSubmit={(e) => e.preventDefault()} className="max-w-3xl mx-auto space-y-4 p-6 text-2xl text-black border-orange-200 hover:border-orange-300">
        ...
        <div>
          <label className="block text-xl font-medium mt-10 text-black">संदेश</label>
        ...
        <Button type="button" className="w-full text-xl rounded-full bg-green-300 hover:bg-orange-600 text-black mb-3" onClick={handleNext}>
          अगला
        </Button>
      </form>
    )}
