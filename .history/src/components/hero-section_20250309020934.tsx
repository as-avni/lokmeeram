    ...
    <section className="relative h-80 md:h-screen pt-0 overflow-hidden">
      ...
      <div className="container md:mt-0 mt-8 relative z-10 flex flex-col items-start justify-center h-full text-white">
        <div className=" max-w-2xl">
          <h1 className="mb-4 text-white md:text-6xl font-bold font-amita leading-tight md:text-7xl">
          लोक में राम
          </h1>
          <p className="mb-4 text-3xl font-kalam">सनातन परंपरा और ऋषि ज्ञान को जन जन तक पहुंचाने का अभियान है लोक मै रामै ।</p>
        </div>
      </div>
    </section>
  )
