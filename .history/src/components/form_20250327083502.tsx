...
<section id="reg-form" className="mx-auto px-4 py-10 flex justify-center items-center bg-[url('/images/background/form-bg.png')] bg-contain bg-center bg-no-repeat">
