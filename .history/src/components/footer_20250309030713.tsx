    ...
    return (
        <footer className="bg-[#0B1220] text-white bg-[url('/images/footer-bg.png')] bg-cover h-full md:h-[400]" >
        <div className="container mx-auto px-4 py-8 mt-8">
            ...
            <div className="py-10">
                ...
                <p>📞 <a href="tel:+91 9669175192" className="hover:underline hover:text-orange-600">+919669175192</a></p>
                <p>📠 <a href="tel:+91 9669175192" className="hover:underline hover:text-orange-600">+919669175192</a></p>
                </div>
            </div>
            ...
            <div className="py-10">
                ...
                <Link href="https://www.facebook.com/LokMeRam" target="_bl" className="text-xl font-semibold hover:text-orange-600 text-black ">
                    <Facebook className="w-6 h-6" />
                    <span className="sr-only">Facebook</span>
                </Link>
                <Link href="https://x.com/LokMeRam?t=-jTM9wsZIpuoRR9IhRBcrw&s=09&fbclid=PAZXh0bgNhZW0CMTEAAaaAYIWH3durzpoB6Ol9spshyuJ5i_PKyK9q9xiR-5NYkdKbj_KpM2vbv8Q_aem_G1N3OyXyTFd-03oMCNFS8w" target="_bl" className="text-xl font-semibold hover:text-orange-600 text-black ">
                ...
                <Link href="#" className="text-xl font-semibold hover:text-orange-600 text-black ">
