...
<section id="reg-form" className="mx-auto px-4 py-10 flex justify-center items-center bg-[url('/images/background/form-bgg.png')] bg-cover bg-center bg-no-repeat">
