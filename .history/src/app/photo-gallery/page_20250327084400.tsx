...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="relative mx-auto px-4 py-12 h-auto md:h-[700px] mt-4 bg-[url('/images/background/gallery-bg.png')] bg-cover bg-center bg-no-repeat bg-opacity-20">
      <div 
