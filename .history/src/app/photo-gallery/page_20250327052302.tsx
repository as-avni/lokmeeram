            ...
            {[1, 2, 3].map((i, index) => (
              <CarouselItem 
                ...
                className={`basis-full md:basis-1/3 transition-transform ${
                  index === 1 ? "scale-110 z-20" : "scale-90 opacity-80 z-0"
                }`}
              >
                <Image
                  ...
                  width={800}
                  height={600}
                  className="w-full h-[250px] md:h-[500px] object-cover rounded-3xl cursor-pointer border-t-4 border-b-4 border-black"
