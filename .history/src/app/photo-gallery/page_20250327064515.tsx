          ...
          <CarouselContent className="flex justify-center items-center flex-nowrap overflow-visible relative z-10 gap-2 sm:gap-4">
            {images.map((i, index) => (
              ...
              className={`basis-1/3 sm:basis-1/3 transition-transform duration-500 ease-in-out relative overflow-visible ${
                  index === 1 
                    ? "scale-110 sm:scale-125 z-40 translate-y-0 overflow-visible" // Keep center image fully visible
            ...
            >
              <Image
                ...
                width={800}
                height={600}
                className="w-full h-[200px] sm:h-[500px] object-cover cursor-pointer border-black overflow-visible"
