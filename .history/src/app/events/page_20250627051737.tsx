...
export default function EnhancedWireframeCards() {
  ...
  return (
    <section className="w-full mx-auto px-4 bg-[url('/images/background/bg-events.png')] bg-cover bg-no-repeat bg-center bg-fixed">
      <div className="max-w-xl mx-auto">
      <h1 className="text-3xl text-black text-center md:text-5xl px-20 font-bold mb-2 md:mb-8 md:mt-28">आयोजन</h1>
      <div className="space-y-4 flex flex-col items-center">
        {cardData.map((card) => (
          <Card key={card.id} className="w-[90%] md:w-3/4 p-4 bg-transparent">
            <CardContent>
