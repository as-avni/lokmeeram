...
export default function EnhancedWireframeCards() {
  ...
  return (
    <div className=" bg-center bg-no-repeat min-h-screen">
    <section className="w-full max-w-5xl mx-auto px-4 bg-[url('/images/background/bg-events.png')] bg-cover bg-center py-10 md:py-20">
