  ...
  return (
    ...
    <section className="w-full max-w-2xl mx-auto p-4">
      ...
      <div className="space-y-4">
        {cardData.map((card) => (
          <Card key={card.id} className="w-full p-8 min-h-[220px] bg-white/30 backdrop-blur-md rounded-xl shadow-lg">
            {/* <CardHeader>
            ...
            <CardContent>
              <div className="flex gap-4 items-center">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="text-base text-gray-500">{card.date}</div>
