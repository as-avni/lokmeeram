  ...
  return (
    ...
    <section className="w-full max-w-2xl mx-auto p-4">
      ...
      <div className="space-y-4">
        {cardData.map((card) => (
          <Card key={card.id} className="w-full p-6 bg-black/10 hover:bg-black/20 transition-all duration-200 rounded-lg shadow-lg">
            {/* <CardHeader>
            ...
            <CardContent>
              <div className="flex gap-4 items-center">
                ...
                <div
                  className="w-32 h-32 bg-gray-200 border-2 border-gray-300 rounded flex-shrink-0 cursor-pointer hover:bg-gray-300 transition-all duration-200 hover:scale-105 hover:shadow-md"
