    ...
    return (
        <section id="about" className="w-full py-12 px-4 items-center gap-4 bg-[url('/images/about-team/about-us-bg.png')] bg-cover h-auto md:h-[600]">
            ...
            <div className="flex flex-col md:flex-row border-spacing-2">
                <div className="flex-1 w-full md:w-1/2 md:mx-10 my-10 border border-gray-500 shadow-xl rounded-lg bg-yellow-100">
                    <p className="text-black mx-5 text-lg md:text-2xl max-w-lg md:max-w-3xl">
                        <span className="font-bold">सनातन परंपरा और ऋषि ज्ञान को जन जन तक पहुंचाने का नाम है ।</span>
                    </p>
                    <p className="font-bold text-black text-lg md:text-2xl max-w-lg md:max-w-xl text-justify">लोक में राम - लोक क्या है?</p>
                    <p className="text-black text-lg md:text-2xl max-w-lg md:max-w-3xl">लोक वह है जिसमें वनस्पति से बृहस्पति तक सभी कुछ समाया हुआ है।
                    ...
                    {expanded && (
                        <>
                            <p className="text-black text-lg md:text-2xl max-w-lg md:max-w-3xl">संस्कृति, प्रकृति और विकृति
                    ...
                    <button 
                        ...
                        className="mt-4 text-black font-bold text-lg/[30px] bg-yellow-200 rounded-3xl w-1/6">
