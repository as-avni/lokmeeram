    ...
    return (
        <section id="about" className="w-full py-12 px-4 items-center gap-4 bg-[url('/images/about-team/about-us-bg.png')] bg-cover h-auto md:h-[600]">
            ...
            <div className="flex flex-col md:flex-row">
                <div className="flex-1 w-full md:w-1/2 md:mx-10 my-10">
                    ...
                    <button 
                        ...
                        className="mt-4 text-black font-bold text-lg bg-orange-200 rounded-full">
                ...
                <div className="flex-1 flex justify-center w-full md:w-1/2 mb-4">
                    <Image
                        ...
                        width={400}
                        height={400}
                        className="rounded-lg w-full md:w-[50%] h-[90%]"
                    />
                </div>
            </div>
        </section>
