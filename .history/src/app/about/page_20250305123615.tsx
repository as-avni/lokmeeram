    ...
    return (
        <section id="about" className="w-full py-12 px-4 items-center gap-4 bg-[url('/images/about-team/about-us-bg.png')] bg-cover h-auto md:h-[600]">
            ...
            <div className="flex flex-col md:flex-row border-spacing-2">
                <div className="flex-1 w-full md:w-1/2 md:mx-10 md:my-4 mb-4 md:mb-4 border border-gray-500 shadow-slate-600 shadow-2xl rounded-xl bg-yellow-100 h-[80%]">
                    ...
                    <button 
                        ...
                        className=" mx-5 mt-4 mb-3 md:mb-4 md:py-4 text-black font-bold text-lg/[30px] bg-yellow-200 rounded-3xl w-1/6">
                        {expanded ? "कम पढ़ें" : "और पढ़ें"}
                    </button>
                </div>
                <div className="flex-1 flex justify-center w-full md:w-1/2 mb-4 h-[80%]">
                    <Image
