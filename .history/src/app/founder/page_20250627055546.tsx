...
<div className="max-w-5xl mx-auto items-center">
    ...
    <h3 className="text-2xl font-bold mb-1 text-center font-[Poppins] text-orange-500">
        डॉ. अशोक चतुर्वेदी
    </h3>
    ...
    <p className="text-xl text-black w-full">
        दण्डकारण्य क्षेत्र के बस्तर स्थित दुर्गकोबडल में जन्में श्री डॉ. अशोक हरिवंश <strong>‘भैया जी’</strong> ...
