...
//         <div className="max-w-lg mx-auto mt-5 md:mt-10">
...
//             <p className="text-lg font-semibold text-gray-800 mb-2">संयुक्त 
//             कमिशनर, पंचायत एवं ग्रामीण विकास विभाग, छत्तीसगढ़ शासन</p>
//             <p className="text-xl w-full text-gray-500">दण्डकारण्य क्षेत्र के बस्तर स्थित दुर्गकोबडल में जन्में श्री डॉ. अशोक हरिवंश <strong> ‘भैया जी’</strong> राजनीति शास्त्र, मानव संसाधन प्रबंधन एवं मानवाधिकार विषयों में उच्च शिक्षा प्राप्त भैया जी प्रशासन में एक उत्कृष्ट अधिकारी के रूप में विद्यमान हैं।
...
export default function Founders() {
    return (
        ...
        >
            <div className="max-w-6xl mx-auto">
                <h1 className="text-3xl text-black text-center md:text-5xl px-20 font-bold mb-2 md:mb-4 mt-20">
                    <span className="text-orange-600">संस्थापक </span> के विषय में
                </h1>

                <div className="max-w-lg mx-auto mt-5 md:mt-10 space-y-10">
                    {/* Dr. Ashok Chaturvedi */}
                    <div className="p-6 bg-transparent">
                        ...
                        <h3 className="text-2xl font-bold mb-1 text-center font-[Poppins] text-orange-500">डॉ. अशोक चतुर्वेदी</h3>
                        ...
                        <p className="text-xl textt-black w-full text-gray-500">
                    ...
                    {/* Nagendra Dubey
                    <div className="p-6 bg-orange-200 shadow-lg shadow-black">
                        <div className="aspect-square relative mb-4 rounded-lg overflow-hidden">
                            <Image
                                src="/images/about-team/3.png"
                                alt="Team member"
                        ...
                        <p className="text-lg text-gray-500 text-justify">
                            एक प्रतिष्ठित <strong>शिक्षाविद्, मोटिवेशनल स्पीकर और काउंसलर</strong>, जिन्हें शिक्षा, पारिवारिक और व्यक्तिगत मार्गदर्शन में व्यापक अनुभव है। उन्होंने <strong>300 से अधिक स्कूलों का दौरा</strong> किया और <strong>4,000+ छात्रों</strong> को प्रेरित किया है। वे <strong>टॉपर्स एजुकेशनल सोसायटी</strong> के सचिव, <strong>विजडम वे हायर सेकेंडरी स्कूल</strong> के निदेशक और <strong>"सतत् छत्तीसगढ़"</strong> पत्रिका के संपादक हैं। <strong>राष्ट्रीय पुस्तक मेला, साहित्य महोत्सव और शिक्षा मेले</strong> के आयोजक होने के नाते, वे शिक्षा और युवा सशक्तिकरण के लिए प्रतिबद्ध हैं। उनके प्रेरणादायक संवाद कौशल, व्यवहारगत समझ और आध्यात्मिक दृष्टिकोण ने उन्हें एक प्रभावशाली व्यक्तित्व बनाया है।
                        </p>
                    </div> */}
                </div>
            </div>
