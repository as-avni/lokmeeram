...
export default function Founders() {
    return (
        <section
            id="team"
            className="px-4 py-12 md:py-16 bg-[url('/images/background/team-bg.png')] bg-op bg-cover bg-center bg-no-repeat bg-blend-color-burn"
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
                    ...
                    <div className="max-w-5xl mx-auto items-center">
                        ...
                        <h3 className="text-2xl font-bold mb-1 text-center font-[Poppins] text-black">डॉ. अशोक चतुर्वेदी</h3>
                            ...
                            <p className="text-xl text-black w-full text-justify">
                                <strong>दण्डकारण्य क्षेत्र के बस्तर स्थित दुर्गकोबडल</strong> में जन्में श्री डॉ. अशोक हरिवंश <strong>‘भैया जी’</strong> <strong>राजनीति शास्त्र, मानव संसाधन प्रबंधन एवं मानवाधिकार विषयों में उच्च शिक्षा प्राप्त</strong> भैया जी <strong>प्रशासन में एक उत्कृष्ट अधिकारी</strong> के रूप में विद्यमान हैं।
                                जगद्गुरु श्रीरामानुजाचार्य की कृपा एवं माता-पिता के निर्देश में बचपन से ही धर्म के क्षेत्र में <strong>“राम और राष्ट्र एक”</strong> मंत्र को जीवन का ध्येय मानुषि, धर्म एवं राष्ट्र की सेवा में समर्पित होकर <strong>श्री रामकथा वाचक</strong> के रूप में प्रचार-प्रसार कर रहे हैं।
                                <strong>भारतीय संस्कृति एवं विरासत की पुनर्स्थापना</strong> हेतु प्रयास करना, <strong>धर्मांतरण के विकराल</strong> तथा <strong>नशामुक्ति हेतु अभियान का संचालन</strong>, देश के हर घर में <strong>श्रीरामचरितमानस एवं श्रीमद्भागवद्गीता</strong> का होना सुनिश्चित करने हेतु, <strong>हिंदू धार्मिक बंधनों</strong> के यह शांत वातावरण में <strong>भारतीय आश्रम के अनुभव</strong> भी प्रदान करता है।
                            </p>
                    </div>
