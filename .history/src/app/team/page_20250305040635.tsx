...
export default function Team() {
    return (
        ...
        <Card className="bg-orange-200 shadow-lg shadow-black">
            ...
            <p className="text-lg text-gray-500 prose text-justify">एक सम्मानित <strong>रशासनिक अधिकारी, शिक्षाविद् और समाजसेवी</strong>, जिनके पास <strong>19+ वर्षों का प्रशासनिक अनुभव</strong> है। उन्होंने <strong>ISO प्रमाणित पंचायत कार्यालय</strong> की स्थापना और <strong>डिजिटल प्रशासनिक सुधार</strong> को आगे बढ़ाने में महत्वपूर्ण भूमिका निभाई है। उनका योगदान <strong>नीति निर्माण, प्रशिक्षण और ग्रामीण विकास</strong> में सराहनीय रहा है। समाज सेवा और आध्यात्मिक गतिविधियों में सक्रिय रहते हुए, वे *राम कथा, सांस्कृतिक जागरूकता और पर्यावरण संरक्षण* अभियानों से जुड़े हुए हैं। साथ ही, वे *YouTube, Facebook और Instagram* पर भी सक्रिय रहते हैं, जहाँ वे अपने विचार और सामाजिक पहल साझा करते हैं।</p>
            </CardContent>
        </Card>
