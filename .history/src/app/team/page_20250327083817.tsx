...
export default function Team() {
    return (
        <section id="team" className="px-4 py-12 md:py-16 bg-[url('/images/background/team-bg.png')] bg-blend-color-burn bg-cover bg-center bg-no-repeat overflow-visible">
